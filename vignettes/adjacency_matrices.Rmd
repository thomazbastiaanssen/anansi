...
krebs_layout <- data.frame(
    ...
    circular = F, 
    name = c("isocitrate", "ketoglutarate", "succinyl-CoA", 
...
graph_from_data_frame(d, directed = TRUE) |>
    ...
    coord_equal(xlim = c(-1.25, 1.25), ylim = c(-1, 1), 
                ratio = 1, clip = "off") +
    theme_graph()
```
...
kl <- data.frame(
    enzyme = factor(
      c("aconitase","aconitase", "isocitrate\ndehydrogenase", 
        "ketoglutarate\ndehydrogenase", "succinyl-CoA\nsynthetase", 
        "succinate\ndehydrogenase", "fumarase",  
        "malate\ndehydrogenase", "citrate\nsynthase"), 
      levels = (
        c("aconitase", "isocitrate\ndehydrogenase", 
        "ketoglutarate\ndehydrogenase", "succinyl-CoA\nsynthetase", 
        "succinate\ndehydrogenase", "fumarase",  
        "malate\ndehydrogenase", "citrate\nsynthase"))), 
    metab = factor(
      c("citrate","cis-aconitate",  "isocitrate","ketoglutarate", 
        "succinyl-CoA","succinate","fumarate","L-malate", "oxaloacetate"), 
      levels = (
        c( "citrate","cis-aconitate",  "isocitrate", "ketoglutarate", 
           "succinyl-CoA", "succinate","fumarate","L-malate", "oxaloacetate"))), 
...
krebs_edge_df <- data.frame(
  Enzyme = c("isocitrate dehydrogenase", "isocitrate dehydrogenase", 
"ketoglutarate dehydrogenase", "ketoglutarate dehydrogenase", 
"succinyl-CoA synthetase", "succinyl-CoA synthetase", 
"succinate dehydrogenase", "succinate dehydrogenase", "fumarase", "fumarase", "malate dehydrogenase", "malate dehydrogenase", "citrate synthase", "citrate synthase", "aconitase", "aconitase", "aconitase"), 
Metabolite = c("isocitrate", "ketoglutarate", "ketoglutarate", "succinyl-CoA", "succinyl-CoA", "succinate", "succinate", "fumarate", "fumarate", "L-malate", 
"L-malate", "oxaloacetate", "oxaloacetate", "citrate", "citrate", 
