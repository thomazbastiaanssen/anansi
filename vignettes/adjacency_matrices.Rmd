...
```{r}
#| plot-krebs, echo=FALSE, fig.small=TRUE, warning=FALSE, message=FALSE,
#| fig.cap="Simplified representation of the Krebs cycle. Boxes mark
#| metabolites and arrows mark enyzmes. "
library(patchwork)
library(ggraph)
library(igraph)
library(tidyverse)
...
graph_from_data_frame(d, directed = TRUE) |>
    ...
    geom_edge_link(arrow = arrow(length = unit(4, 'mm')), 
                   end_cap = circle(15, 'mm'), aes(label = vertices)) + 
    geom_node_label(aes(label = name, fill = name), show.legend = FALSE) +
