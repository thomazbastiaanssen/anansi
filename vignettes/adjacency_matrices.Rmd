...
Recall that the 
[citric acid cycle, or Krebs cycle](https://en.wikipedia.org/wiki/Citric_acid_cycle), is a central piece of metabolic machinery. In short, it enables oxidative phosphorylation. See figure below for a simplified representation with 8 unique
enzymatic reactions and 9 unique metabolites. 
