...
#' @name krebs
#' @description
#' Enzymes and metabolites that make up the Krebs cycle. Features share a row
#' when they play a role in the same reaction.
#' Used in vignettes, exported to facilitate user exploration.
#' @format A `data.frame` of two factors, named `"Enzyme"` and `"Metabolite"`,
#'     which contain these respective components of the krebs cycle.
#' @source Generated by hand based on the krebs cycle.
#' @importFrom utils data
#' @usage data("krebs", package = "anansi")
#'
"krebs"
...
#' @usage data("ec2ko", package = "anansi")
"ec2ko"
...
#'     `KEGGREST`. Script to generate available in example.
#' @usage data("ec2cpd", package = "anansi")
#'
"ec2cpd"
...
#' @usage data("FMT_data", package = "anansi")
#'
"FMT_metab"
